...
function copy() {
	...
	echo -e "Copying configuration files from /src/main/resources/etc/cas/ to /etc/cas"
	cp -rfv /src/main/resources/etc/cas/* /etc/cas

    mkdir -p /etc/cas/services
	cp -rfv /src/main/resources/services/* /etc/services
}
